public interface BinaryTreeNode<E extends Comparable<E>> {
     ...
     * @return the parent node of the current node. If the current node is the root, an error message 
     * is printed. 
     */
     ...
     * @return the left child node of the current node. If the current node doesn't have a left child,
     ...
     * @return the right child node of the current node. If the current node doesn't have a right child,
     * an error message is printed. 
     */
    public BinaryTreeNode<E> getRightChild();

    /**
     * Add a left child for the current node, containing the specified element. If the current node 
     * already has a left child, an error message is printed. 
     */
    public void addLeftChild(E element);

    /**
     * Add a right child for the current node, containing the specified element. If the current node 
     * already has a right child, an error message is printed. 
     */
    public void addRightChild(E element);

    /** 
     * Delete the current node. If the node cannot be deleted it prints an error message.
     */
    public void delete();
